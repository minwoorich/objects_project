...
//    private String productNo;
    ...
    @Builder
    private Product(Category category, List<OrderDetail> orderDetails, Boolean isOwn, String name, Long price, Boolean isSubs, Long stock, String thumbImg, Long discountRate) {
