...
import static com.objects.marketbridge.domain.order.domain.StatusCodeType.ORDER_CANCEL;
import static com.objects.marketbridge.domain.order.domain.StatusCodeType.RETURN_COMPLETED;
