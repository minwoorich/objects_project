...
////        Category category = categoryRepository.findById(createProductRequestDto.getCategoryId()).get();
////
...
//        // 상품 ID에 해당하는 상품을 찾음
//        Product findProduct = productRepository.findById(id).get();
//        Category category = categoryRepository.findById(updateProductRequestDto.getCategoryId()).get();
//
//        if(findProduct == null){
